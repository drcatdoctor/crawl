...
static const species_skill_aptitude species_skill_aptitudes[] =
{
    ...
    APT(SP_GARGOYLE,         SK_ARMOUR,         -2),
    APT(SP_GARGOYLE,         SK_DODGING,        -1),
    APT(SP_GARGOYLE,         SK_STEALTH,         2),
#if TAG_MAJOR_VERSION == 34
    APT(SP_GARGOYLE,         SK_STABBING,        0),
#endif
    APT(SP_GARGOYLE,         SK_SHIELDS,        -2),
    ...
    APT(SP_GARGOYLE,         SK_CHARMS,         -2),
    APT(SP_GARGOYLE,         SK_SUMMONINGS,     -1),
    APT(SP_GARGOYLE,         SK_NECROMANCY,     -3),
    APT(SP_GARGOYLE,         SK_TRANSLOCATIONS, -1),
    APT(SP_GARGOYLE,         SK_TRANSMUTATIONS, -1),
    APT(SP_GARGOYLE,         SK_FIRE_MAGIC,     -1),
    APT(SP_GARGOYLE,         SK_ICE_MAGIC,       1),
